...
public class DataRowHandlerForPhoneNumber extends DataRowHandlerForCommonDataKind {
    ...
    public long insert(SQLiteDatabase db, TransactionContext txContext, long rawContactId,
        ...
        if (values.containsKey(Phone.NUMBER)) {
            ...
            */
            ...
            ContactProxyManager.getInstance(mContext).onDataUpdate(rawContactId,tmp,Phone.CONTENT_ITEM_TYPE);
            /**
            * @}
            */
    ...
    public boolean update(SQLiteDatabase db, TransactionContext txContext, ContentValues values,
        ...
        */
        ...
        /**
        * SPRD:
        *   Move this sentence here when merge from 4.1 to 4.3.
        *
        * Original Android code:
        * please see the same sentence blow;
        * 
        * @{
        */
...
//            long rawContactId = c.getLong(DataUpdateQuery.RAW_CONTACT_ID);
            ...
            /**
             * SPRD:
             *   make sure updating the data, to avoid the case like updating.
             *   is_primary
             * @{
             */
            ContentValues tmp=new ContentValues(values);
    ...
    public void appendSearchableData(IndexBuilder builder) {
        ...
        */
        ...
        for (int i=1;i<N;++i) {
            builder.appendToken(normalizedNumber.substring(i,Math.min(i+MAX_SEARCH_SNIPPET_SIZE,N)));
        }
        /**
        * @}
        */
    ...
    * @{
    */
    Pattern mPhoneNumPattern=Pattern.compile("[^0-9\\+,;N\\*#]");
    /**
    * @}
    */
}
