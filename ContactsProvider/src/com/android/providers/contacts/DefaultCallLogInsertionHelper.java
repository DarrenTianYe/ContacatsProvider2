...
import com.sprd.providers.geocode.GeocodeUtils;
    ...
    public void addComputedValues(ContentValues values) {
        ...
        if (GeocodeUtils.isSupportSprdGeocode()) {
            values.put(Calls.GEOCODED_LOCATION,
                    Geocode.getGeocodedLocation(mContext, values.getAsString(Calls.NUMBER)));
        } else if(GeocodeUtils.isSupportGoogleGeocode()){
            values.put(Calls.GEOCODED_LOCATION,
