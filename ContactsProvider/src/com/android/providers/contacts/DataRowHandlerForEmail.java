...
public class DataRowHandlerForEmail extends DataRowHandlerForCommonDataKind {
    ...
    public long insert(SQLiteDatabase db, TransactionContext txContext, long rawContactId,
        ...
        * @{
        */
        ContactProxyManager.getInstance(mContext).onDataUpdate(rawContactId,values,Email.CONTENT_ITEM_TYPE);
        /**
        * @}
        */
    ...
    public int delete(SQLiteDatabase db, TransactionContext txContext, Cursor c) {
        ...
        ContactProxyManager.getInstance(mContext).onDataUpdate(rawContactId,tmp,Email.CONTENT_ITEM_TYPE);
        /**
         * @}
         */
