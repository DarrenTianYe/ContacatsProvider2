...
public class CallLogProviderParent extends ContentProvider {
    private static final String TAG = "CallLogProviderParent";
    private static final boolean DBG = false;
    public static final boolean UNIVERSEUI_SUPPORT = SystemProperties.getBoolean("universe_ui_support",false); 
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        case CONTACTS_AND_CALLLOG: {
            ...
            mDbHelper = ContactsDatabaseHelper.getInstance(getContext());
            ...
            qb.appendWhere(" AND " + DataColumns.MIMETYPE_ID + " = " + mDbHelper.getMimeTypeIdForPhone());
