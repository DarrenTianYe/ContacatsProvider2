...
public class DataRowHandlerForStructuredName extends DataRowHandler {
    ...
    public long insert(SQLiteDatabase db, TransactionContext txContext, long rawContactId,
        ...
        * @{
        */
        ContactProxyManager.getInstance(mContext).onDataUpdate(rawContactId,values,StructuredName.CONTENT_ITEM_TYPE);
        /**
        * @}
        */
    ...
    public int delete(SQLiteDatabase db, TransactionContext txContext, Cursor c) {
        ...
        */
        ...
        ContactProxyManager.getInstance(mContext).onDataUpdate(rawContactId,tmp,StructuredName.CONTENT_ITEM_TYPE);
        /**
        * @}
        */
    ...
    public void appendSearchableData(IndexBuilder builder) {
        ...
        */
        ...
        if (!TextUtils.isEmpty(phoneticFamily) || !TextUtils.isEmpty(phoneticMiddle)
            ...
            * @{
            */
            DataRowHandler.appendSearchableData(builder,mSb.toString().trim());
            /**
            * @}
            */
