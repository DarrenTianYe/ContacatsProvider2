    ...
    */
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        try {
            ...
            Log.i(TAG, "insert : SQLiteFullException");
            transaction.removeDbForTag(mSerializeDbTag);
            return null;
        } finally {
    ...
    private void endTransaction(boolean callerIsBatch) {
        ...
        if (transaction != null && (!transaction.isBatch() || callerIsBatch)) {
            try {
                ...
                /*
                * SPRD:
                *   fix bug 259518 when database or disk is full,catch the SQLiteException.
                * @{
                */
            } catch (SQLiteFullException e){
                Log.i(TAG, "endTransaction : SQLiteFullException");
            } catch (SQLiteCantOpenDatabaseException e){
                Log.i(TAG, "endTransaction : SQLiteCantOpenDatabaseException");
                /*
                 * @}
                 */
            } finally {
