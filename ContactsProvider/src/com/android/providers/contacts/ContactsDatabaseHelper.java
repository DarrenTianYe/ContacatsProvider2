...
public class ContactsDatabaseHelper extends SQLiteOpenHelper {
    ...
    public interface Joins {
         ...
         * table must be named as "groups". Adds the "group_member_count column"
         * to the query, which will be null if a group has no members. Use
         * ifnull(group_member_count, 0) if 0 is needed instead.
         */
        
        /**
        * SPRD:
        *  modify here for bug 114970,after joining contacts,group member count is error
        * @{
        */
        public static final String GROUP_MEMBER_COUNT =
                " LEFT OUTER JOIN (SELECT "
                        + "data.data1 AS member_count_group_id, "
                        + "COUNT(DISTINCT(raw_contacts.contact_id)) AS group_member_count "
    ...
    public interface Clauses {
        ...
        * @{
        */
        String NOT_SYNCABLE_ACCOUNT_IDS =
                "(SELECT " + AccountsColumns._ID +
                        " FROM " + Tables.ACCOUNTS +
                        " WHERE (" +
                        AccountsColumns.ACCOUNT_NAME + " IS NULL AND " +
                        ...
                        AccountsColumns.DATA_SET + " IS NULL)" +
                        " OR (" +
                        AccountsColumns.ACCOUNT_TYPE + " =  \"sprd.com.android.account.phone\")" +
                        ")";
        /**
         * @}
         */
    ...
    public interface ContactsColumns {
        ...
        public static final String PHONEBOOK_BUCKET_ALTERNATIVE = "phonebook_bucket_alt";
 			 /**
         * add by xuhong.tian start
         */
        public static final String CONTACT_IMPORT_TYPE = Tables.CONTACTS + "."
                + Contacts.CONTACT_IMPORT_TYPE;
        
        public static final String CONTACAT_MODE_TYPE= Tables.CONTACTS + "."
    ...
    public interface RawContactsColumns {
         ...
         * add by xuhong.tian start
         */
        public static final String CONCRETE_CONTACTS_IMPORT_TYPE =
                Tables.RAW_CONTACTS + "." + RawContacts.RAW_CONTACT_IMPORT_TYPE;
        public static final String CONCRETE_CONTACTS_MODE_TYPE =
                Tables.RAW_CONTACTS + "." + RawContacts.RAW_CONTACT_MODE_TYPE;
        /**
         * add by xuhong.tian end
         */
    }
    ...
    public interface GroupsColumns {
         ...
         * add by xuhong.tian start
         */
        public static final String GROUP_NUMBER = Tables.GROUPS + "." + Groups.GROUP_NUMBER;
        public static final String GROUP_BY_IMPORT_TYPE = Tables.GROUPS + "." + Groups.GROUP_BY_IMPORT_TYPE;
        public static final String Group_CURRENT_MODE = Tables.GROUPS + "." + Groups.GROUP_CURRENT_MODE;
        public static final String Group_CURRENT_LOCATION = Tables.GROUPS + "." + Groups.GROUP_LOCATION;
        public static final String Group_DEFAULT = Tables.GROUPS + "." + Groups.GROUP_DEFAULT;
        public static final String Group_TYPE = Tables.GROUPS + "." + Groups.GROUP_TYPE;
        public static final String Group_ZONE_NAME = Tables.GROUPS + "." + Groups.GROUP_ZONE_NAME; 
        public static final String Group_ZONE_ID = Tables.GROUPS + "." + Groups.GROUP_ZONE_ID;
        public static final String Group_ID = Tables.GROUPS + "." + Groups.GROUP_ID;
        public static final String Group_RESPONSE_FLAG = Tables.GROUPS + "." + Groups.GROUP_RESPONSE_FLAG; 
        /**
         * add by xuhong.tian end
         */
    ...
    public interface NameLookupColumns {
        ...
        public static final String CONTACT_MODE= "current_mode_type";
        public static final String CONTACT_TYPE= "current_import_type";
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + Tables.CONTACTS + " (" +
                ...
                Contacts.CONTACT_IMPORT_TYPE + " INTEGER NOT NULL DEFAULT 0," +
                Contacts.CONTACAT_MODE_TYPE + " INTEGER NOT NULL DEFAULT 5" +
        ");");
/**
 * add by xuhong.tian .default value is 5 beacuse the before is used by mpt pdt ....
 */
        ...
        db.execSQL("CREATE TABLE " + Tables.RAW_CONTACTS + " (" +
                ...
                RawContacts.RAW_CONTACT_IMPORT_TYPE + " INTEGER NOT NULL DEFAULT 0, " +
                RawContacts.RAW_CONTACT_MODE_TYPE + " INTEGER NOT NULL DEFAULT 5 " +
        ");");
...
//        ");");
        ...
        db.execSQL("CREATE TABLE " + Tables.GROUPS + " (" +
                ...
                Groups.SYNC3 + " TEXT, " +
                Groups.SYNC4 + " TEXT, " +
                Groups.GROUP_NUMBER+ " INTEGER NOT NULL DEFAULT 0, " +
                Groups.GROUP_BY_IMPORT_TYPE+ " INTEGER NOT NULL DEFAULT 0, " +
                Groups.GROUP_CURRENT_MODE+ " INTEGER NOT NULL DEFAULT 0, " +
                Groups.GROUP_LOCATION+ " TEXT, " +
                Groups.GROUP_ZONE_NAME+ " INTEGER NOT NULL DEFAULT 0, " +
                Groups.GROUP_ZONE_ID+ " INTEGER NOT NULL DEFAULT 0, " +
                Groups.GROUP_ID+ " INTEGER NOT NULL DEFAULT 0, " +
                Groups.GROUP_RESPONSE_FLAG+ " INTEGER NOT NULL DEFAULT 0, " +
                Groups.GROUP_DEFAULT+ " INTEGER NOT NULL DEFAULT 0, " +
                Groups.GROUP_TYPE+ " INTEGER NOT NULL DEFAULT 0" +
        ");");
        ...
        db.execSQL("CREATE TABLE " + Tables.CALLS + " (" +
                ...
                /* SPRD: add @{ */
                Calls.PHONE_ID + " INTEGER," +
                Calls.VIDEO_CALL_FLAG + " INTEGER," +
                 ...
                 * add by xuhong.tian
                 */
                Calls.CALL_MODE + " INTEGER NOT NULL DEFAULT 4" +
        ");");
    ...
    private void createContactsViews(SQLiteDatabase db) {
        ...
        String syncColumns =
                ...
                + RawContactsColumns.CONCRETE_CONTACTS_IMPORT_TYPE + " AS " + RawContacts.RAW_CONTACT_IMPORT_TYPE + ","
                + RawContactsColumns.CONCRETE_CONTACTS_MODE_TYPE + " AS " + RawContacts.RAW_CONTACT_MODE_TYPE;
        ...
        String contactOptionColumns =
                ...
                + ContactsColumns.CONTACT_IMPORT_TYPE
                        + " AS " + RawContacts.RAW_CONTACT_IMPORT_TYPE + ","
                + ContactsColumns.CONTACAT_MODE_TYPE
                        + " AS " + RawContacts.RAW_CONTACT_MODE_TYPE + ","
        ...
        String contactNameColumns =
                ...
                + "name_raw_contact." + RawContacts.RAW_CONTACT_IMPORT_TYPE
                		+ " AS " + Contacts.CONTACT_IMPORT_TYPE+ ", "
                + "name_raw_contact." + RawContacts.RAW_CONTACT_MODE_TYPE
                		+ " AS " + Contacts.CONTACAT_MODE_TYPE;
    ...
    private void createGroupsView(SQLiteDatabase db) {
        ...
        String groupsColumns =
                ...
                + GroupsColumns.GROUP_NUMBER + " AS " + Groups.GROUP_NUMBER+ ","
                + GroupsColumns.GROUP_BY_IMPORT_TYPE + " AS " + Groups.GROUP_BY_IMPORT_TYPE+ ","
                + GroupsColumns.Group_CURRENT_MODE + " AS " + Groups.GROUP_CURRENT_MODE+ ","
        		+ GroupsColumns.Group_CURRENT_LOCATION + " AS " + Groups.GROUP_LOCATION+ ","
        		+ GroupsColumns.Group_ZONE_NAME + " AS " + Groups.GROUP_ZONE_NAME+ ","
        		+ GroupsColumns.Group_ZONE_ID + " AS " + Groups.GROUP_ZONE_ID+ ","
        		+ GroupsColumns.Group_ID + " AS " + Groups.GROUP_ID+ ","
        		+ GroupsColumns.Group_RESPONSE_FLAG + " AS " + Groups.GROUP_RESPONSE_FLAG+ ","
        		+ GroupsColumns.Group_DEFAULT + " AS " + Groups.GROUP_DEFAULT+ ","
        		+ GroupsColumns.Group_TYPE + " AS " + Groups.GROUP_TYPE;
    ...
    private void insertNormalizedNameLookup(SQLiteStatement stmt, long rawContactId, long dataId,
        ...
        try {
            ...
            Log.e(TAG, "insertNormalizedNameLookup: disk I/O error");
        }
        /**
         * @}
         */
            ...
            while (c.moveToNext()) {
                ...
                if (mimeType == getMimeTypeIdForStructuredName()) {
                    ...
                    */
                    ...
                    mCharArrayBuffer.sizeCopied = 0;
                    c.copyStringToBuffer(RawContactNameQuery.DATA1,
                            mCharArrayBuffer);
                    if (mCharArrayBuffer.sizeCopied != 0) {
                        bestDisplayNameSource = source;
                        bestDisplayName = new String(mCharArrayBuffer.data, 0,
                                mCharArrayBuffer.sizeCopied);
                        // do a special if it is a phone number
                        bestDisplayName = bestDisplayName.replace(',', 'P');
                        bestDisplayName = bestDisplayName.replace(';', 'W');
                        bestPhoneticName = null;
                        bestPhoneticNameStyle = PhoneticNameStyle.UNDEFINED;
                    }
                    /**
