...
/**
* SPRD:
*  Singleton holder for all parsed Accounts available on the system, typically
*  filled through {@link AccountManager} queries.
* 
* @{
*/
    ...
    public Account getSimAccount(int phoneId) {
        ...
        synchronized (mAccounts) {
            for (Account account : mAccounts) {
                String slot = mAccountManager.getUserDataPrivileged(account, "slot");
                if (slot != null) {
